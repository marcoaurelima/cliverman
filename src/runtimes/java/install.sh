...
step_0() {
  ...
  printf "\033[2;97m[0/4]\033[0m Checking availability of \033[2;97m%s v%s \033[0m\n" "${name}" "${version}"
...
step_3() {
  ...
  printf "\033[90m" 
  tar -xzf "${temp_path}" -C "${installs_path}" --strip-components=1 --checkpoint=1700 --checkpoint-action='ttyout=%c'
